...
- [ ] T004 Add/update module boundaries for frontend JS structure (`pages/`, `components/`, `api/`, shared utilities)
...
- [ ] T011 Define/confirm API contracts and error models for impacted user stories
- [ ] T012 Add data integrity checks (constraints/indexes/validation) for impacted entities
